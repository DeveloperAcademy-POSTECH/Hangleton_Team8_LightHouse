...
struct Constants {
    ...
    static let GestureArray = [
        Gesture(mainCategory:.requiredFeatures,
                title:"VoiceOver를 시작하기",
                subTitle:"VoiceOver를 켜거나 끄는 방법",
        ...
        Gesture(mainCategory:.tabAndHoldTwoFingers,
                title:"두 손가락으로 한 번 탭하고 누른 채로 있기",
                subTitle:"항목 레이블 정하기",
